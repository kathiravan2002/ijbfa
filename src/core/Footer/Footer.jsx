...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#1687A7] text-white py-4 md:py-5 lg:py-3 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 relative">
          ...
          <div className="mt-1 md:mt-40 md:absolute md:left-0 lg:mt-25 md:top-0  ">
            <img src={logo} alt="OJS Logo" className="w-20 sm:w-24 lg:w-28 h-auto" />
          </div>
     
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 mt-1 sm:mt-5 poppins-bold">
              Resources
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2 lg:mb-0 mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-center text-center text-sm sm:text-base poppins-regular ">
          <p>© 2025 IJBFA. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
