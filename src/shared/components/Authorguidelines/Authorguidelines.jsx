      ...
      <div className="text-justify max-w-[90rem] mx-auto lg:pr-2 pr-2 lg:p-0 p-2 ">
        ...
        <div className='bg-[#D3E0EA] mt-4 rounded-lg p-4'>
          ...
          <div>
            ...
            <div className='flex items-start  mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>Original research articles presenting new findings, methodologies, and experiments in cloud computing and security systems.</p></div>
          ...
          <div>
            ...
            <div className='flex items-start  mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>Comprehensive reviews summarizing and analyzing existing research and trends in cloud computing and security. </p></div>
          ...
          <div>
            ...
            <div className='flex items-start  mt-4 gap-2'><img src={check} alt="checkmark" className='w-[26px] h-[20px]' /><p className='poppins-regular '>Articles focusing on practical applications, technical advancements, and innovative solutions in cloud computing and security. </p></div>
